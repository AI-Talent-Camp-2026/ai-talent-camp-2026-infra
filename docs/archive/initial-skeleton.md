# ⚠️ АРХИВ - Начальная структура проекта

> **Статус:** Устарело - сохранено для истории  
> **Дата создания:** 2025-12-XX  
> **Актуальная документация:** См. [modules.md](../modules.md), [architecture.md](../architecture.md)

**Примечание:** Это был начальный skeleton проекта. Финальная реализация отличается от этого плана. Для понимания текущей структуры см. актуальную документацию.
